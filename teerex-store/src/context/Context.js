...
// const API_LINK = 'https://geektrust.s3.ap-southeast-1.amazonaws.com/coding-problems/shopping-cart/catalogue.json';
// const initialState = {
//     products: [],
//     cart: []
// }
...
const Context = ({ children }) => {
    ...
    // useEffect(() => {
    //     axios.get(API_LINK).then(response => {dispatch({ products: response.data }) }).catch(err => console.log(err))
    // }, [])
    const products = [
        {
            "id": 1,
